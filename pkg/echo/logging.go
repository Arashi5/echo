...
func NewLoggingService(ctx context.Context, s Service) Service {
	...
	logger = log.With(logger, "domain", "echo")
...
func (s *loggingService) CreateEcho(ctx context.Context, req *CreateEchoRequest) (resp *CreateEchoResponse, err error) {
...
func (s *loggingService) GetEcho(ctx context.Context, req *GetEchoListRequest) (resp *GetEchoListResponse, err error) {
	defer func(begin time.Time) {
		m := getInfoFromContext(ctx)
		m = append(m,
			"code", getHTTPStatusCode(err),
